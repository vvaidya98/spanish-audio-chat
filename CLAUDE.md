...
**Current Version:** v1.0l (Live in Production)  
...
- [x] Mobile responsiveness polish (Phase 1 pass) — shipped v1.0l (SAC-022/023); a deeper redesign (SAC-025/027/028) is still Phase 2
...
- [ ] Reorder main screen, Listening first — SAC-025
- [ ] Progress bar jump-to-sentence markers — SAC-026
- [ ] Vocabulary matching redesign (one-at-a-time) — SAC-027
- [ ] Vocabulary context (example phrases) — SAC-028
- [ ] Story caching — SAC-029
...
- **Every numbered prompt gets a Prompt Log entry** (this project uses SAC- prefix for PENDING items, separate from Prompt numbers; currently at Prompt #010)
